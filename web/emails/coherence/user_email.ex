...
defmodule MyAnimeList.Coherence.UserEmail do
  @moduledoc false
  use Phoenix.Swoosh, view: MyAnimeList.Coherence.EmailView, layout: {MyAnimeList.Coherence.LayoutView, :email}
  alias Swoosh.Email
  require Logger
  alias Coherence.Config
  import MyAnimeList.Gettext
